...
export default function UpdateProperty() {
    ...
    useEffect(() => {
        const fetchListing = async () => {
            const listingId = params.propertyid;
            const res = await fetch(`/api/v1/property/get/${listingId}`);
            console.log(res);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate(`/property-listing/${data._id}`);
        } catch (error) {
